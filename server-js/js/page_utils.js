...
var editpage = function (use_404_param) {
    if (use_404_param === void 0) { use_404_param = false; }
    hidePageUtilities();
    ...
    prsRequest("beginEditPage", args, function (d) {
...
var savepage = function (refresh, use_404_param) {
    if (use_404_param === void 0) { use_404_param = false; }
    args = {};
    ...
    prsRequest("changePage", args, function (d) {
        if (refresh)
            if (!use_404_param)
...
var canceleditpage = function () {
    hidePageUtilities();
    prsRequest("removeEditLock", { pagename: get_slug() }, function (d) {
        window.location.reload();
    });
};
var scpvote = function (rate) {
    if (rate > 1 || rate < -1)
        return;
    prsRequest('voteOnPage', { pagename: get_slug(), rating: rate }, function (d) {
        if ('not_logged_in' in d && d.not_logged_in) {
...
var showrater = function () {
    hidePageUtilities();
    prsRequest("getRatingModule", { pagename: get_slug() }, function (d) {
        if ('result' in d && !d.result) {
